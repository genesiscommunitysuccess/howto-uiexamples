...
Genesis components are registered with a [Design System](https://docs.genesis.global/docs/develop/client-capabilities/styling/direct-customization-genesis-components/styling-direct-dsc/),
and the default system is named `rapid`. Design systems are highly configurable. You can configure them by importing and
modifying the tokens directly, or by using our [Design System Configuration](https://docs.genesis.global/docs/develop/client-capabilities/styling/direct-customization-genesis-components/styling-direct-dsc/)
