...
In `ListItems` connected callback we first load the data. We use the async [connect.snapshot](https://learn.genesis.global/docs/web/comms/docs/api/foundation-comms.connect.snapshot/?_highlight=snapshot) method
